...
ProjectPath            :=E:/Study/C/Master-the-C-Language/WriteCode/CChallenge/CTest
IntermediateDirectory  :=../build-$(WorkspaceConfiguration)/CTest
...
$(IntermediateDirectory)/test.c$(ObjectSuffix): test.c $(IntermediateDirectory)/test.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/Study/C/Master-the-C-Language/WriteCode/CChallenge/CTest/test.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/test.c$(ObjectSuffix) $(IncludePath)
